...
function SurveyDetails({detailsHandler, title, description, setTitle, setDescription}){
    return(
        <form onSubmit={function(e){e.preventDefault(), detailsHandler(title, description)}}>
